    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Мои бронирования</h2>
            {myBookings.length === 0 ? (
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Бронирования моих вещей</h2>
            {itemsBookings.length === 0 ? (
              <div className="card text-center py-8">
                <p className="text-gray-500">Нет бронирований ваших вещей</p>
              </div>
            ) : (
              <div className="space-y-4">
  ...
  return (
    ...
    >
      <div className="card">
        ...
        {!isOwner && booking.item.owner.telegram_username && (
