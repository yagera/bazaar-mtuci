...
const translations: Translations = {
  ...
  'home.dormitoryPlaceholder': { ru: 'Выберите общежитие', en: 'Select dormitory' },
  ...
  'register.passwordRecommended': { ru: 'Рекомендуется 8+ символов', en: 'Recommended 8+ characters' },
  'register.confirmPassword': { ru: 'Подтвердите пароль', en: 'Confirm Password' },
  'register.confirmPasswordPlaceholder': { ru: 'Повторите пароль', en: 'Repeat password' },
  ...
  'myItems.restoreConfirm': { ru: 'Восстановить объявление?', en: 'Restore item?' },
  'myItems.edit': { ru: 'Редактировать', en: 'Edit' },
  'myItems.delete': { ru: 'Удалить', en: 'Delete' },
  'myItems.restore': { ru: 'Восстановить', en: 'Restore' },
